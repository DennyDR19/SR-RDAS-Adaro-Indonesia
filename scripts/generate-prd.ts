...
<head>
  <meta charset="utf-8">
  <title>Product Requirement Document (PRD) - SIG Rehabilitasi DAS PT Adaro Indonesia</title>
  <!--[if gte mso 9]>
  <xml>
    <w:WordDocument>
      <w:View>Print</w:View>
...
<body>
  <div class="header-cover">
    ...
    <h2>Sistem Informasi Geografis & Monitoring Kinerja Petak Ukur (PU) Rehabilitasi DAS</h2>
    <div class="meta">
      <strong>Institusi / Pemilik:</strong> PT Adaro Indonesia - Divisi Lingkungan & Reklamasi DAS | 
      <strong>Versi:</strong> 2.4.0 (Final Release) | 
      <strong>Tanggal Rilis:</strong> 22 September 2026
    </div>
  </div>
...
fs.writeFileSync(
  path.join(outputDir, 'PRD_SIG_Rehabilitasi_DAS_PT_Adaro_Indonesia.doc'),
  '\ufeff' + docContent,
  'utf-8'
);
console.log('Successfully generated PRD .doc file in public directory!');
...
doc.setFontSize(7.5);
doc.text('PT Adaro Indonesia - Divisi Lingkungan & Reklamasi DAS | Versi 2.4.0', margin, 23);
...
fs.writeFileSync(path.join(outputDir, 'PRD_SIG_Rehabilitasi_DAS_PT_Adaro_Indonesia.pdf'), pdfBuffer);
console.log('Successfully generated PRD .pdf file in public directory!');
